...
const translations = {
  EN: {
    title: "About Us",
    intro: "MalligeMitra is dedicated to connecting communities and empowering users. Learn more about our mission, vision, and team.",
    sections: [
      {
        heading: "Our Mission",
        content:
    ...
    contact: "Contact us at malligemitra@gmail.com for more information."
  },
  KN: {
    title: "ನಮ್ಮ ಬಗ್ಗೆ",
    intro: "MalligeMitra ಸಮುದಾಯಗಳನ್ನು ಸಂಪರ್ಕಿಸುವ ಮತ್ತು ಬಳಕೆದಾರರನ್ನು ಶಕ್ತಗೊಳಿಸುವ ಕಾರ್ಯಕ್ಕೆ ಸಮರ್ಪಿತವಾಗಿದೆ. ನಮ್ಮ ಗುರಿ, ದೃಷ್ಟಿ ಮತ್ತು ತಂಡದ ಬಗ್ಗೆ ಇನ್ನಷ್ಟು ತಿಳಿಯಿರಿ.",
    sections: [
      {
        heading: "ನಮ್ಮ ಗುರಿ",
        content:
    ...
    contact: "ಹೆಚ್ಚಿನ ಮಾಹಿತಿಗಾಗಿ malligemitra@gmail.com ಅನ್ನು ಸಂಪರ್ಕಿಸಿ."
  }
};
