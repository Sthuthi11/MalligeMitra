...
// --- Type Definitions ---
// Defining these here ensures they are available for this page
        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-emerald-50 to-lime-100">
            ...
            <main className="flex-1 container mx-auto p-4">
                ...
                <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
                    ...
                    <Link href="/farmer/forum/ask" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 shadow-md">
                        {t.askQuestion}
                    </Link>
                </div>
                    ...
                    {questions.length === 0 && !loading && !error ? (
                        ...
                        questions.map((question) => (
                            <div key={question.id} className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition duration-200">
                                <Link href={`/farmer/forum/questions/${question.id}`}>
                                ...
                                <div className="mt-4 text-right">
                                    <Link href={`/farmer/forum/questions/${question.id}`} className="text-blue-600 hover:underline font-medium">
